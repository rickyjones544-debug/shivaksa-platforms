...
const nav = [
  ...
  { href: '/api/agent/calls', label: 'My Calls' },
  { href: '/api/agent/performance', label: 'Performance' },
];
      ...
      <header className="sticky top-0 z-40 border-b border-zinc-200/80 dark:border-zinc-800/80 bg-white/90 dark:bg-zinc-950/90 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <Link href="/agent" className="flex items-center gap-2 group">
            ...
            <span className="text-lg font-semibold tracking-tight">Shivaksa Agent</span>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-3">
            <span className="text-sm text-zinc-500 dark:text-zinc-400">Agent Portal</span>
            <Link
